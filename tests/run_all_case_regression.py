"""Run every canonical TwinGuide case and persist an incremental summary."""
...
CONFIGS = (
    *(ROOT / "examples" / f"case-tooth-{fdi}.json" for fdi in (11, 12, 13, 14, 15, 16, 17, 47)),
    *(ROOT / "examples" / f"case-teeth-{pair}.json" for pair in ("12-13", "14-15", "15-16", "16-17")),
)
...
def main() -> int:
    ...
    for index, config_path in enumerate(CONFIGS, start=1):
        ...
        try:
            ...
            config = CaseConfig.from_json(config_path)
